...
Upstream source snapshots were inspected directly on 2026-09-22; exact source revisions are intentionally omitted here because 40-character Git commit IDs collide with a default secret-scanner token pattern.
